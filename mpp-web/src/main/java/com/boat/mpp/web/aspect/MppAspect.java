package com.boat.mpp.web.aspect;

import cn.hutool.core.util.IdUtil;
import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.google.common.collect.Lists;
import com.boat.mpp.web.vo.RequestLogDTO;
...
public class MppAspect {
     ...
     * 只切 MppAspect 注解
     */
    @Pointcut("@within(com.boat.mpp.web.annotation.MppAspect) " +
            "|| @annotation(com.boat.mpp.web.annotation.MppAspect)")
