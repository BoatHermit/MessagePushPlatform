package com.boat.mpp.cron.pending;
...
import com.boat.mpp.cron.constants.PendingConstant;
...
import com.boat.mpp.support.pending.PendingParam;
...
public class CrowdBatchTaskPending extends AbstractLazyPending<CrowdInfoVo> {
    ...
    public CrowdBatchTaskPending() {
        ...
        pendingParam.setQueue(new LinkedBlockingQueue(PendingConstant.QUEUE_SIZE))
                ...
                .setNumThreshold(MppConstant.BATCH_RECEIVER_SIZE)
