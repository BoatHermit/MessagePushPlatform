...
import com.boat.mpp.common.dto.model.SmsContentModel;
import com.boat.mpp.common.enums.ChannelType;
import com.boat.mpp.handler.domain.sms.MessageTypeSmsConfig;
        ...
        try {
            ...
            for (MessageTypeSmsConfig messageTypeSmsConfig : messageTypeSmsConfigs) {
                ...
                List<SmsRecord> recordList = applicationContext
                        .getBean(messageTypeSmsConfig.getScriptName(), SmsScript.class).send(smsParam);
