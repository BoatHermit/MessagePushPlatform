package com.boat.mpp.datawarehouse;

import com.boat.mpp.datawarehouse.constants.DataHouseConstant;
import org.apache.flink.streaming.api.environment.StreamExecutionEnvironment;
import org.apache.flink.table.api.SqlDialect;
import org.apache.flink.table.api.bridge.java.StreamTableEnvironment;
import org.apache.flink.table.catalog.hive.HiveCatalog;

public class MppHiveBootStrap {

    public static void main(String[] args) {

        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment()
                .setParallelism(1).enableCheckpointing(3000);
        ...
        // 2.创建Kafka源表
        String kafkaSourceTableCreate = "DROP TABLE IF EXISTS " + DataHouseConstant.CATALOG_DEFAULT_DATABASE
                + "." + DataHouseConstant.KAFKA_SOURCE_TABLE_NAME;
        ...
        kafkaSourceTableDdl = kafkaSourceTableDdl
                .replace("<CATALOG_DEFAULT_DATABASE>", DataHouseConstant.CATALOG_DEFAULT_DATABASE)
        ...
        tableEnv.executeSql("DROP TABLE IF EXISTS " + DataHouseConstant.CATALOG_DEFAULT_DATABASE
                + "." + DataHouseConstant.KAFKA_SINK_TABLE_NAME);
        String kafkaSinkTableDdl =
                ...
                ")";
        kafkaSinkTableDdl = kafkaSinkTableDdl
                .replace("<CATALOG_DEFAULT_DATABASE>", DataHouseConstant.CATALOG_DEFAULT_DATABASE)
        ...
        tableEnv.executeSql("INSERT INTO " + DataHouseConstant.CATALOG_DEFAULT_DATABASE
                + "." + DataHouseConstant.KAFKA_SINK_TABLE_NAME
                + " SELECT ids,state,businessId,logTimestamp FROM " + DataHouseConstant.CATALOG_DEFAULT_DATABASE
                + "." + DataHouseConstant.KAFKA_SOURCE_TABLE_NAME);
    }
}
